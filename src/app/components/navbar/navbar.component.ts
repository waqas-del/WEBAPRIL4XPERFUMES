    ...
    <header class="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16 md:h-20 relative">
          ...
          <!-- Left Actions (Mobile Only) -->
          <div class="flex items-center md:hidden flex-1">
            <!-- Empty space to balance the logo centering -->
          </div>

          <!-- Logo -->
          <div class="flex-shrink-0 flex items-center justify-center md:justify-start flex-1 md:flex-none">
            <a routerLink="/" class="text-2xl font-serif font-bold tracking-tighter text-gray-900 whitespace-nowrap">
          ...
          <!-- Actions (Right) -->
          <div class="flex items-center justify-end space-x-2 sm:space-x-4 flex-1 md:flex-none">
            <!-- Cart Icon -->
        ...
        <!-- Mobile Second Row Menu -->
        <div class="md:hidden flex justify-center space-x-6 pb-3 pt-1 overflow-x-auto no-scrollbar">
          <a routerLink="/best-sellers" routerLinkActive="text-gold-600" class="text-gray-600 text-[11px] font-bold uppercase tracking-wider whitespace-nowrap">Best Sellers</a>
          <a routerLink="/new-arrivals" routerLinkActive="text-gold-600" class="text-gray-600 text-[11px] font-bold uppercase tracking-wider whitespace-nowrap">New Arrivals</a>
        </div>
      </div>
    </header>
  `
